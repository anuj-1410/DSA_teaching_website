        ...
        <div className="container-outer">
            <div style={{ width: isOpen ? "200px" : "50px" }} className="sidebar">
                <div className="top_section">
                    <h1 style={{ display: textVisible && isOpen ? "block" : "none", opacity: textVisible ? 1 : 0 }} className="logo">Sorting</h1>
                    <div style={{ marginLeft: textVisible && isOpen ? "30px" : "0px" }} className="bars">
